...
public class PostHandler {
    public String doPost(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, IOException {
        String body = request.getParameter("inputTextArea"); //text from Area

        StringBuilder ret = new StringBuilder(); //return-String

        try {
            boolean result = runCode(body);
    ...
    private boolean runCode(String code) throws Exception {
        String patternString = "Hi, World!"; // String, mit dem die Ausgabe verglichen wird
